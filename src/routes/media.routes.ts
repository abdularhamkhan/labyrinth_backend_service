 ...
 */
router.post("/avatar", authMiddleware, uploadAvatar, handleUploadError, uploadAvatarController);
 ...
 */
router.post("/chat", authMiddleware, uploadChatMedia, handleUploadError, uploadChatMediaController);
